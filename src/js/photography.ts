(function() {
  ...
  function render() {
    ...
    var selector = albumGrid ? '.album-card-link' : '.photo-card';
    var all = grid.querySelectorAll(selector);
    all.forEach(function(c) { (c as HTMLElement).style.display = 'none'; });
    ...
    visible.forEach(function(c) { (c as HTMLElement).style.display = ''; });
      ...
      fallbackGrid.querySelectorAll('.photo-card').forEach(function(card, idx) {
        ...
        card.addEventListener('click', function() {
          ...
          fallbackGrid!.querySelectorAll('.photo-card').forEach(function(c) {
            photos.push({ src: c.getAttribute('data-src') || '', caption: c.getAttribute('data-caption') || '' });
          });
          lbShow(idx);
